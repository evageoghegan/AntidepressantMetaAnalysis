...
AligningRatDatasets<-function(ListOfRatDEResults){
  ...
  #Making an empty list to hold our results: This is a list for our differential expression results. Loop will be ran for the number of results e.g here only 2 for mice and 1 for rats
  #Then later, the function join.all will create everything into a dataframe
  ...
  #EntrezGeneID is one trace ID, result for one gene for every dataset, and repeat
  ...
  #type full means you want to keep everything but one row per gene
  #You use this type of function A LOT - joining and aligning is important
  #It is in joining data with dplyr course

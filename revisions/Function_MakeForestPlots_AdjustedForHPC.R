...
#Megan Hagenauer
#July 25 2024
#Adjusted March 2026 for revisions in the antidepressant manuscript
...
#This code makes the Forest Plot
  ...
  pdf(paste("ForestPlot_Mouse", MouseGeneSymbol,"Rat", RatGeneSymbol,".pdf", sep="_"), height=6, width=8)
  ...
  mtext(paste("Mouse", MouseGeneSymbol, "Rat", RatGeneSymbol, sep="_"), line=-0.5, cex=2)

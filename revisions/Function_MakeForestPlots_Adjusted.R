...
#This code makes the Forest Plot
  ...
  pdf(paste("ForestPlot_Mouse", MouseGeneSymbol,"Rat", RatGeneSymbol,".pdf", sep="_"), height=11, width=8.5)
  ...
  mtext(paste("Mouse", MouseGeneSymbol, "Rat", RatGeneSymbol, sep="_"), line=-1, cex=2)

...
#don't need this bit below because you already have the contrast IDs
...
#For this code, have taken out all contrast IDs without fluoxetine
...
#Rename the results of interest 
ComparisonsOfInterest<-c("GSE56028_imipramine", "GSE56028_fluoxetine", "GSE56028_agomelatine")
...
#Rename the results of interest 
ComparisonsOfInterest<-c("GSE63469_venlafaxine high dose", "GSE63469_venlafaxine low dose")
#Collapse into one result per gene
source("Function_CollapsingDEResults_OneResultPerGene.R")
CollapsingDEResults_OneResultPerGene(GSE_ID, DE_Results_GoodAnnotation, ComparisonsOfInterest, NamesOfFoldChangeColumns, NamesOfTstatColumns)
...
#GSE84183 has been removed again because needs to be reanalysed
#Needs to have mice datasets as well

ListOfMouseDEResults<-list(DEResults_GSE27532, DEResults_GSE63469, DEResults_GSE81672)
...
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="98970", species="Mouse") 

MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="231440", species="Mouse")

#Making fgsea results for whole meta-analysis output and combination of Phi's and Adrienne's results
...
write.csv(GSEA_Results, "Phi_Adrienne_data_whole_meta_fgsea.csv")

...
#This has been updated to include the three new renanalyzed datasets
...
#This code calculates the number of NAs (i.e., the number of statistical contrasts lacking real differential expression results) in each row (i.e., for each gene):
...
#CutOffForNAs=2
#I have 22 (17 from original, now four reanalyzed) statistical contrasts total (comparisons)
...
#Focus on strong p-values and a lot of results, e.g low p-value, low FDR and have more than 13 results
...
###############################################################################
 ...
 #Kcnk10
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="72258", species="Mouse") 
#Gpr160
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="71862", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="16675", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="83436", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="230587", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="109323", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="11595", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="81897", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="217946", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="63955", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="214345", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="54199", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="107375", species="Mouse") 

#Forest plots - significant genes - upregulated and downregulated - top ones 6 ones from each for #19 -22 comparisons:

#Upregulated:
#Slc35d2	70484
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="70484", species="Mouse") 
#Tnni1	21952
...
#Iqcg	69707
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="69707", species="Mouse") 
#Zfp691	195522
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="195522", species="Mouse") 
#Stxbp5	78808
...
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="63955", species="Mouse") 
#Gpr182	11536
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="11536", species="Mouse") 



#Top Upregulated overall:
 # Plekha2, Acan, Glis1
# Plekha2 83436
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="83436", species="Mouse") 
#Acan 11595
...
#Top upregulated with 19+ comparisons:
#  Tnni1, Dmrtb1, Slc35d2
#Slc35d2	70484
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="70484", species="Mouse") 
#Tnni1	21952
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="21952", species="Mouse") 
...
#Notable upregulated ones otherwise:
#  Ccrl2 54199, Tlr9 81897
...
#Top downreg overall:
#  Fxbw10, Unc13c, Or13a28
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="18362", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="208898", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="213980", species="Mouse") 
#Top down reg with 19+ comparisons:
 # C1qtnf7 Mertk, Kcnk10
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="17289", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="109323", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="72258", species="Mouse") 

#Notable downreg overall: Clcn2, cables1, 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="12724", species="Mouse") 
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="63955", species="Mouse") 

#Gbp2
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="14469", species="Mouse") 
#pea15 18611
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="18611", species="Mouse") 

# Tbx 19 83993
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="83993", species="Mouse") 

#Pea15a 18611
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="18611", species="Mouse") 

#Ankrd7 75196
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="75196", species="Mouse") 
...
#nrsn1
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="22360", species="Mouse") 
...
#13590 lefty1
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="13590", species="Mouse") 

#Adpating this code to only include the non-traditional antidepressant datasets for comparisons
#June 6th 2025
#Added tianeptine and agomelatine June 21st 2025
...
#For this code, have taken out all contrast IDs with traditional antidepressants
#Leaving ketamine, TMS and ECT

ResultSet_contrasts<-read.csv("ResultSets_Screened_NonTrad.csv", header=TRUE, stringsAsFactors = FALSE )
...
#Rename the results of interest 
ComparisonsOfInterest<-c("GSE230149_Intermittent_Theta_Burst")
...
#Rename the results of interest 
ComparisonsOfInterest<-c("GSE81672_ketamine")
#Collapse into one result per gene
source("Function_CollapsingDEResults_OneResultPerGene.R")
CollapsingDEResults_OneResultPerGene(GSE_ID, DE_Results_GoodAnnotation, ComparisonsOfInterest, NamesOfFoldChangeColumns, NamesOfTstatColumns)
...
#Rename the results of interest 
ComparisonsOfInterest<-c("GSE56028_agomelatine", "GSE56028_tianeptine")
#Collapse into one result per gene
source("Function_CollapsingDEResults_OneResultPerGene.R")
CollapsingDEResults_OneResultPerGene(GSE_ID, DE_Results_GoodAnnotation, ComparisonsOfInterest, NamesOfFoldChangeColumns, NamesOfTstatColumns)
...
ListOfMouseDEResults<-list(DEResults_GSE123027, DEResults_GSE73798, DEResults_GSE81672)

AligningMouseDatasets(ListOfMouseDEResults)

#################

ListOfRatDEResults<-list(DEResults_GSE230148, DEResults_GSE230149, DEResults_GSE56028)
...
#'data.frame':	26286 obs. of  6 variables:
...
#[3] "MouseVsRat_EntrezGene.ID"           "GSE123027_ECT"                     
#[5] "GSE73798_ketamine"                  "GSE81672_ketamine"                 
#[7] "GSE230148_TMS_modifier_theta_burst" "GSE230148_TMS_1Hz"                 
#[9] "GSE230149_Intermittent_Theta_Burst" "GSE56028_agomelatine"              
#[11] "GSE56028_tianeptine"

#Example scatter plot comparing two datasets:
plot(MetaAnalysis_FoldChanges$GSE73798_ketamine~MetaAnalysis_FoldChanges$GSE81672_ketamine)
...
#0     1     2     3     4     5     6     7     8 
#11297   906  1734  1404   228  3611  4470  4358    90 
...
#I have 8 statistical contrasts total (comparisons)
...
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="", species="") 

### No significant (<0.05FDR) on 21st June 2025
#Making a heatmap
...
Log2FC_Subsetted_Matrix <- as.matrix(metaOutputFDR_wFoldChanges_Top50_byLog2FC[,c(21:28)])
...
setwd("/Users/evageoghegan/Comparison for Phi")
getwd()
...
pdf("Non_trad_Heatmap_TopMetaGenes_50_color_scale_narrow.pdf",
    height = 11, width = 8.5)

#Making fgsea results for non-trad only meta output and combination of Phi's and Adrienne's results
...
DEResults<-read.csv("Nontrad_metaOutputFDR_orderedByPval.csv", header=TRUE, stringsAsFactors = FALSE)
...
write.csv(GSEA_Results, "Phi_Adrienne_data_non_trad_fgsea.csv")

#1) combining the gene annotation file and limma results for each PFC dataset into a single file
#2) save it as a .csv
...
#GSE118670 - reanalyzed, in folder

setwd("/Users/evageoghegan/PFC")
library(dplyr)
DE_Results <- read.csv("GSE118670_PFC.csv")
